...
export default function Post({ post }: { post: IPost }) {
  return (
    <div className="w-full rounded-4xl p-8 flex flex-col justify-between bg-no-repeat bg-cover font-unbounded gap-35" style={{
      ...
      <footer className='w-full flex flex-col gap-4'>
        <div className="flex gap-8 items-center">
          <Heart className='size-8 text-light-white' />
          <MessageSquare className='size-8 text-light-white' />
          <Repeat2 className='size-8 text-light-white' />
        </div>
